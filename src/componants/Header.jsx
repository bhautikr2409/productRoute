...
//         headerRef.current.classList.add("headerSticky");
//       } else {
//         headerRef.current.classList.remove("headerSticky");
//       }
//     }
//   };
...
//   return (
//     <header className="bg-gray-800 text-white sticky top-0 w-full">
